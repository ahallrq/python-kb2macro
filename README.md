...
```
cd existing_repo
git remote add origin https://gitlab.com/andrewhall649/python-kb2macro.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/andrewhall649/python-kb2macro/-/settings/integrations)
